		...
		data() {
			return {
				pList:[
					...
					{
						title:"服务条款",content:[
						" 我们的小程序提供的服务包括但不限于信息展示、交流互动、交易等。",
						"我们有权根据实际情况调整或终止部分或全部服务。"
					]},
					{
						title:"用户信息保护",content:[
						" 我们尊重并保护用户的隐私，不会泄露用户的个人信息。",
						"用户在使用我们的小程序时，需要提供一些个人信息，如手机号、邮箱等。",
						"我们将采取技术措施保护用户的个人信息安全。"
					]},	{
						title:"用户行为规范",content:[
						"用户在使用我们的小程序时，应遵守法律法规和社会公德。",
						"用户不得利用我们的小程序进行任何违法、违规或有悖公序良俗的活动。",
						"用户不得利用我们的小程序进行任何违法、违规或有悖公序良俗的活动。"
					]},	{
						title:" 知识产权",content:[
						"我们的小程序及其中的内容（包括但不限于文字、图片、视频等）的知识产权归我们所有。",
						"用户在使用我们的小程序时，不得侵犯我们的知识产权。"
					]},	{
						title:"免责条款",content:[
						"我们不对我们的小程序的服务中断或故障负责。",
						"我们不对用户因使用我们的小程序而遭受的任何损失负责。",
						"我们不对用户之间的纠纷负责。"
					]},	{
						title:" 协议修改",content:[
						"我们有权根据实际情况修改本协议。",
						"修改后的协议将在我们的小程序上公布，并立即生效。"
					]}
					,{
						title:"争议解决",content:[
