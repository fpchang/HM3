<template>
  <view class="content">
    ...
    <view class="menu-one">
      ...
      <view class="item-list">
        ...
        <view class="item item_">
          <navigator :url="`/pages_client/hotelHome/hotelHome?hotel_id=${hotel_id}`"
    ...
    <view class="menu-two">
      <view class="subtitle">财务管理</view>
      <view class="item-list">
        <view class="item">
          <navigator url="/pages/financialManagement/income/income" hover-class="navigator-hover">
<view class="item-group">
            <l-icon name="ri:money-cny-circle-fill" size="50px" color="#FFAA00" />
            <view style="text-align: center">收入管理</view>
          </view>
          </navigator>
   ...
   <view class="item-group">
            <l-icon name="material-symbols:finance-chip" size="50px" color="#165DFF" />
            <view style="text-align: center">支出管理</view>
          </view>
          </navigator>
